...
class OpensearchTransport extends Transport {
  ...
  async log(info, callback) {
    ...
    const entry = this.opts.useTransformer ? await this.opts.transformer(logData) : info;

    let index = this.opts.dataStream ? this.opts.index : this.getIndexName(this.opts);
